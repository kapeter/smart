                    ...
                    {{-- <div class="panel"> --}}
                        ...
                        <div class="panel-body">
                            ...
                            @can('editRoles', $dataTypeContent)
                                <div class="form-group">
                                    <label for="default_role">{{ __('voyager::profile.user_role') }}</label>
                                    @php
                                ...
                                <div class="form-group">
                                    <label for="default_role">{{ __('voyager::profile.unit') }}</label>
                                    @php
                                        $dataTypeRows = $dataType->{(isset($dataTypeContent->id) ? 'editRows' : 'addRows' )};

                                        $row     = $dataTypeRows->where('field', 'user_belongsto_tk_unit_relationship')->first();
                                        $options = json_decode($row->details);
                                    @endphp
                                    @include('voyager::formfields.relationship')
                                </div>
<!--                                 <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="phone">{{ __('voyager::profile.phone') }}</label>
                                <input type="text" class="form-control" id="phone" name="phone" placeholder="{{ __('voyager::profile.phone') }}"
